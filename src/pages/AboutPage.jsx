    ...
    <Section ref={ref}>
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <span className="text-text-secondary">Изображение команды</span>
          </div>
        </div>
      </Container>
    </Section>
          ...
          {values.map((value, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-accent/10 rounded-12 flex items-center justify-center flex-shrink-0">
